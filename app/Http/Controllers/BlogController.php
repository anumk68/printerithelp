...
class BlogController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('admin.blog.list', compact('blogs','sort_search','codes'));
    }
    ...
    public function blog_list()
    {
        ...
        $blog_categories = BlogCategory::all();
        return view('frontend.blog', compact('blogs','blog_categories','codes'));
    }
    ...
    public function blog_details($slug)
    {
        ...
        return view("frontend.blog-details", compact('blog','blog_categories','metaKeywords','ogImage','allblogs','metatitle','metaDescription','codes','blogs'));
    }
    ...
    public function show()
    {
        ...
        return view('frontend.blogs.index', compact('blogs','blog_categories','metaDescription', 'metatitle', 'metaKey','codes'));
    }
