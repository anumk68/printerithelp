...
<head>
  <meta charset="utf-8">
  <meta http-equiv="refresh" content="99992">
  ...
  <script>
    $(document).ready(function () {
      ...
      // $('#livechat').delay(20000).fadeIn(); $('#livechat').delay(999999999).fadeOut();
...
<body style="font-family: 'Poppins';">
  <div class="container-fluid">
    <div class="row">
      <div class="col">
        <p>Verify your printer's Wifi connection for a seamless setup process.</p>
        <hr />
      </div>
    </div>
  </div>
  <div class="container text-center ">
    <div class="row align-items-center" style="padding: 10px 0px 10px 0px;">
      <div class="col">
        ...
        <img src="{{ asset('public/images/wifi-setup.png') }}" class="img-fluid" style="width:30%" alt="...">
        ...
        <!-- <div id="offme">
          ...
          <p id="searching-usb" style="text-align: center;">
            <span style="display: inline-flex; align-items: center;">
              <img src="{{ asset('public/images/loding.gif') }}" alt="Your Image"
          ...
          <p id="searching-check-usb-cable" class="myElement">1. Check Wifi connected both side</p>
          <p id="searching-check-drivers">2. Check your device driver (Wifi Drivers)</p>
        </div> -->

        <div id="showsol">
          <div class="">
            <span style="font-size:18px"><b>Wifi connection failed.</b></span>
            <ul style="color:red" class="list-group">
              <li class="list-group-item">Check Wifi on both ends. <a href="{{ route('iframe_fixing') }}">Retry</a></li>
              <li class="list-group-item">Check Wifi drivers. <a href="{{ route('iframe_fixing') }}">Check Drivers</a>
              </li>
            </ul>
          </div>
        </div>
